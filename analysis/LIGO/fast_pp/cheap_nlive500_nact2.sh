...
/usr/bin/time -v python /fred/oz200/avajpeyi/projects/MORPH/nismo/analysis/LIGO/fast_pp/pp_analysis.py --index 0 --sampler dynesty \
  --output-dir /fred/oz200/avajpeyi/projects/MORPH/nismo/analysis/LIGO/fast_pp/outdir/seed_0/cheap_nlive500_nact2 --label cheap_nlive500_nact2 \
  --no-corner --nlive 500 --nact 2 --sample rwalk
